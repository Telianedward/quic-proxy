 ...
 * @param to_fd Сокет, куда пишем данные.
 * @param ssl Указатель на SSL-контекст (nullptr если без TLS).
 * @return true при успешной передаче, false при ошибке или закрытии соединения.
