 ...
 * @brief Тестовый сервер для приёма HTTP/2 соединений от прокси в Нидерландах.
 *
 * Слушает указанный порт (8586) и выводит любое полученное сообщение в лог.
...
int main()
{
    ...
    {
        // --- Настройки ---
        const int listen_port = 8586; // Порт, на котором слушаем (должен совпадать с тем, куда отправляет клиент)
