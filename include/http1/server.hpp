...
private:
    ...
    /**
     * @brief Устанавливает соединение с сервером в России.
     * @return Дескриптор сокета бэкенда или -1 при ошибке.
     */
    [[nodiscard]] int connect_to_backend() noexcept; // 👈 ДОБАВЛЕНО
