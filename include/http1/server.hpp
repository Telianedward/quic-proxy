...
// 🟢 ДОБАВЛЯЕМ СТРУКТУРУ ДЛЯ FLOW CONTROL
    ...
    // 🟢 МЕТОДЫ ДЛЯ FLOW CONTROL
    /**
     * @brief Проверяет, нужно ли приостановить отправку данных клиенту.
     * @param client_fd Дескриптор клиентского сокета.
     * @return true если нужно приостановить отправку, false если можно продолжать.
     */
    [[nodiscard]] bool should_pause_sending(int client_fd) noexcept;

    /**
     * @brief Обновляет состояние flow control для клиента.
     * @param client_fd Дескриптор клиентского сокета.
     * @param client_ready true если клиент готов принимать данные, false если нет.
     */
